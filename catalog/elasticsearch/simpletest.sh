...
curl -XGET 'myes-master-0.t1-firecamp.com:9200/_cluster/health?pretty'
curl -XGET 'http://myes-0.t1-firecamp.com:9200/_cluster/state'
...
curl -XGET 'http://myes-0.t1-firecamp.com:9200/twitter/_search?q=user:kimchy&pretty=true'
